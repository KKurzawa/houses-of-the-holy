  ...
  return (
    <>
      <main className="main rounded-lg">
        <img src="/AlbumArt.jpeg" alt="" className="album-art" />
        ...
        <h3 className="houses-text -mt-3 text-[4rem]">HOUSES OF THE HOLY</h3>
        <h2 className="other-text -mt-3 text-[2rem]">AND OTHER LED-ZEPPELIN CLASSICS</h2>
        <h3 className="date-text -mt-3 text-[3rem]">FEBRUARY 8 2025 AT THE CADIEUX CAFE</h3>
